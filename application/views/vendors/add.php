<div id="content-container">
  <div id="page-head">
    <div id="page-title">
      <h1 class="page-header text-overflow">Add a vendor</h1>
    </div>
    <ol class="breadcrumb">
      ...
      <div class="col-lg-6">
        <div class="panel">
          <div class="panel-heading">
            <h3 class="panel-title">Add a vendor</h3>
          </div>
          <?php echo form_open('vendors/add', array('method' => 'post', 'class' => 'form-horizontal')); ?>
