...
<!-- Mirrored from www.themeon.net/nifty/v2.9/pages-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Mar 2018 04:33:32 GMT -->
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <?php echo form_input('name', '', 'class="form-control" placeholder="Full name"'); ?>
                </div>
                <div class="form-group">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <?php echo form_input('company_name', '', 'class="form-control" placeholder="Company name"'); ?>
                </div>
              </div>
            </div>
            <div class="checkbox pad-btm text-left">
              <?php echo form_checkbox('agree_terms', 'accept', FALSE, 'id="demo-form-checkbox" class="magic-checkbox"'); ?>
