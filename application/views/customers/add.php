<div id="content-container">
  <div id="page-head">
    <div id="page-title">
      <h1 class="page-header text-overflow">Add a customer</h1>
    </div>
    <ol class="breadcrumb">
      ...
      <div class="col-lg-6">
        <div class="panel">
          <div class="panel-heading">
            <h3 class="panel-title">Add a customer</h3>
          </div>
          <?php echo form_open('customers/add', array('method' => 'post', 'class' => 'form-horizontal')); ?>
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <?php echo form_textarea('address', '', 'placeholder="Address" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Phone</label>
                <div class="col-sm-6">
                  <?php echo form_input('phone', '', 'placeholder="Phone" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
              <div class="form-group">
                <label for="demo-is-inputnormal" class="col-sm-3 control-label">Email</label>
                <div class="col-sm-6">
                  <?php echo form_input('email', '', 'placeholder="Email" class="form-control" id="demo-is-inputnormal"'); ?>
                </div>
              </div>
            </div>
